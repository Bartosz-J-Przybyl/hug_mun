...
import 'package:hug_mun/openapi/api_util.dart';
import 'package:hug_mun/openapi/model/create_user_access_token_request.dart';
import 'package:hug_mun/openapi/model/create_user_request.dart';
import 'package:hug_mun/openapi/model/disable_user_access_token_request.dart';
import 'package:hug_mun/openapi/model/enable_user_access_token_request.dart';
import 'package:hug_mun/openapi/model/login_request.dart';
import 'package:hug_mun/openapi/model/revoke_session_request.dart';
import 'package:hug_mun/openapi/model/revoke_user_access_token_request.dart';
import 'package:hug_mun/openapi/model/search_user_access_tokens_request.dart';
import 'package:hug_mun/openapi/model/search_users_request.dart';
import 'package:hug_mun/openapi/model/send_password_reset_email_request.dart';
import 'package:hug_mun/openapi/model/send_verification_email_request.dart';
import 'package:hug_mun/openapi/model/session.dart';
import 'package:hug_mun/openapi/model/status_ok.dart';
import 'package:hug_mun/openapi/model/user.dart';
import 'package:hug_mun/openapi/model/user_access_token.dart';
import 'package:hug_mun/openapi/model/user_access_token_sanitized.dart';
import 'package:hug_mun/openapi/model/user_auth_data.dart';
import 'package:hug_mun/openapi/model/user_limits.dart';
import 'package:hug_mun/openapi/model/user_report.dart';
import 'package:hug_mun/openapi/model/user_terms_of_service.dart';
import 'package:hug_mun/openapi/model/users_stats.dart';
...
class UsersApi {
  ...
  Future<Response<StatusOK>> convertUserToBot({
    ...
    final _path = r'/api/v4/users/{user_id}/convert_to_bot'.replaceAll(
        '{' r'user_id' '}',
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(StatusOK),
            ) as StatusOK;
  ...
  ///
  /// Parameters:
  /// * [createUserRequest] - User object to be created
  ...
  Future<Response<User>> createUser({
    ...
    final _queryParameters = <String, dynamic>{
      if (t != null)
        r't': encodeQueryParameter(_serializers, t, const FullType(String)),
      if (iid != null)
        r'iid': encodeQueryParameter(_serializers, iid, const FullType(String)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserAccessToken] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserAccessToken>> createUserAccessToken({
    required String userId,
    required CreateUserAccessTokenRequest createUserAccessTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/{user_id}/tokens'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(CreateUserAccessTokenRequest);
      _bodyData = _serializers.serialize(createUserAccessTokenRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserAccessToken),
            ) as UserAccessToken;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> deleteUser({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> demoteUserToGuest({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/demote'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> disableUserAccessToken({
    required DisableUserAccessTokenRequest disableUserAccessTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/tokens/disable';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(DisableUserAccessTokenRequest);
      _bodyData = _serializers.serialize(disableUserAccessTokenRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> enableUserAccessToken({
    required EnableUserAccessTokenRequest enableUserAccessTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/tokens/enable';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EnableUserAccessTokenRequest);
      _bodyData = _serializers.serialize(enableUserAccessTokenRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getDefaultProfileImage({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/image/default'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getKnownUsers({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/known';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Session>>> getSessions({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/sessions'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UsersStats] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UsersStats>> getTotalUsersStats({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/stats';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UsersStats),
            ) as UsersStats;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// * [roles] - Comma separated string used to filter users based on any of the specified system roles  Example: `?roles=system_admin,system_user` will include users that are either system admins or system users
  /// * [channelRoles] - Comma separated string used to filter users based on any of the specified channel roles, can only be used in conjunction with `in_channel`  Example: `?in_channel=4eb6axxw7fg3je5iyasnfudc5y&channel_roles=channel_user` will include users that are only channel users and not admins or guests
  /// * [teamRoles] - Comma separated string used to filter users based on any of the specified team roles, can only be used in conjunction with `in_team`  Example: `?in_team=4eb6axxw7fg3je5iyasnfudc5y&team_roles=team_user` will include users that are only team users and not admins or guests
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UsersStats] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UsersStats>> getTotalUsersStatsFiltered({
    String? inTeam,
    String? inChannel,
    bool? includeDeleted,
    bool? includeBots,
    ...
    final _path = r'/api/v4/users/stats/filtered';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (inTeam != null)
        r'in_team':
            encodeQueryParameter(_serializers, inTeam, const FullType(String)),
      if (inChannel != null)
        r'in_channel': encodeQueryParameter(
            _serializers, inChannel, const FullType(String)),
      if (includeDeleted != null)
        r'include_deleted': encodeQueryParameter(
            _serializers, includeDeleted, const FullType(bool)),
      if (includeBots != null)
        r'include_bots': encodeQueryParameter(
            _serializers, includeBots, const FullType(bool)),
      if (roles != null)
        r'roles':
            encodeQueryParameter(_serializers, roles, const FullType(String)),
      if (channelRoles != null)
        r'channel_roles': encodeQueryParameter(
            _serializers, channelRoles, const FullType(String)),
      if (teamRoles != null)
        r'team_roles': encodeQueryParameter(
            _serializers, teamRoles, const FullType(String)),
    };
  ...
  ///
  /// Parameters:
  /// * [userId] - User GUID. This can also be \"me\" which will point to the current user.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [tokenId] - User access token GUID
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserAccessTokenSanitized] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserAccessTokenSanitized>> getUserAccessToken({
    ...
    final _path = r'/api/v4/users/tokens/{token_id}'.replaceAll(
        '{' r'token_id' '}',
    ...
    UserAccessTokenSanitized? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserAccessTokenSanitized),
            ) as UserAccessTokenSanitized;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UserAccessTokenSanitized>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserAccessTokenSanitized>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserAccessTokenSanitized>>> getUserAccessTokens({
    int? page = 0,
    int? perPage = 60,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v4/users/tokens';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<UserAccessTokenSanitized>? _responseData;
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(
                  BuiltList, [FullType(UserAccessTokenSanitized)]),
            ) as BuiltList<UserAccessTokenSanitized>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<UserAccessTokenSanitized>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserAccessTokenSanitized>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserAccessTokenSanitized>>>
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> getUserByEmail({
    ...
    final _path = r'/api/v4/users/email/{email}'.replaceAll(
        '{' r'email' '}',
  ...
  Future<Response<User>> getUserByUsername({
    ...
    final _path = r'/api/v4/users/username/{username}'.replaceAll(
        '{' r'username' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<num>> getUserCountForReporting({
    String? roleFilter,
    String? teamFilter,
    bool? hasNoTeam,
    bool? hideActive,
    ...
    final _path = r'/api/v4/reports/users/count';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (roleFilter != null)
        r'role_filter': encodeQueryParameter(
            _serializers, roleFilter, const FullType(String)),
      if (teamFilter != null)
        r'team_filter': encodeQueryParameter(
            _serializers, teamFilter, const FullType(String)),
      if (hasNoTeam != null)
        r'has_no_team':
            encodeQueryParameter(_serializers, hasNoTeam, const FullType(bool)),
      if (hideActive != null)
        r'hide_active': encodeQueryParameter(
            _serializers, hideActive, const FullType(bool)),
      if (hideInactive != null)
        r'hide_inactive': encodeQueryParameter(
            _serializers, hideInactive, const FullType(bool)),
      if (searchTerm != null)
  ...
  /// Gets the user limits for the server ##### Permissions Requires &#x60;sysconsole_read_user_management_users&#x60;.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserLimits>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserLimits>>> getUserLimits({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/limits/users';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<UserLimits>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(UserLimits)]),
            ) as BuiltList<UserLimits>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<UserLimits>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserTermsOfService] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserTermsOfService>> getUserTermsOfService({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/terms_of_service'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    UserTermsOfService? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserTermsOfService),
            ) as UserTermsOfService;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<UserTermsOfService>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [roles] - Comma separated string used to filter users based on any of the specified system roles  Example: `?roles=system_admin,system_user` will return users that are either system admins or system users  __Minimum server version__: 5.26
  /// * [channelRoles] - Comma separated string used to filter users based on any of the specified channel roles, can only be used in conjunction with `in_channel`  Example: `?in_channel=4eb6axxw7fg3je5iyasnfudc5y&channel_roles=channel_user` will return users that are only channel users and not admins or guests  __Minimum server version__: 5.26
  /// * [teamRoles] - Comma separated string used to filter users based on any of the specified team roles, can only be used in conjunction with `in_team`  Example: `?in_team=4eb6axxw7fg3je5iyasnfudc5y&team_roles=team_user` will return users that are only team users and not admins or guests  __Minimum server version__: 5.26
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (inTeam != null)
        r'in_team':
            encodeQueryParameter(_serializers, inTeam, const FullType(String)),
      if (notInTeam != null)
        r'not_in_team': encodeQueryParameter(
            _serializers, notInTeam, const FullType(String)),
      if (inChannel != null)
        r'in_channel': encodeQueryParameter(
            _serializers, inChannel, const FullType(String)),
      if (notInChannel != null)
        r'not_in_channel': encodeQueryParameter(
            _serializers, notInChannel, const FullType(String)),
      if (inGroup != null)
        r'in_group':
            encodeQueryParameter(_serializers, inGroup, const FullType(String)),
      if (groupConstrained != null)
        r'group_constrained': encodeQueryParameter(
            _serializers, groupConstrained, const FullType(bool)),
      if (withoutTeam != null)
        r'without_team': encodeQueryParameter(
            _serializers, withoutTeam, const FullType(bool)),
      if (active != null)
        r'active':
            encodeQueryParameter(_serializers, active, const FullType(bool)),
      if (inactive != null)
        r'inactive':
            encodeQueryParameter(_serializers, inactive, const FullType(bool)),
      if (role != null)
        r'role':
            encodeQueryParameter(_serializers, role, const FullType(String)),
      if (sort != null)
        r'sort':
  ...
  /// * [since] - Only return users that have been modified since the given Unix timestamp (in milliseconds).  __Minimum server version__: 5.14
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<User>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> getUsersByIds({
    ...
    final _path = r'/api/v4/users/ids';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<User>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> getUsersByUsernames({
    required BuiltList<String> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/usernames';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserReport>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserReport>>> getUsersForReporting({
    ...
    final _path = r'/api/v4/reports/users';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (sortColumn != null)
        r'sort_column': encodeQueryParameter(
            _serializers, sortColumn, const FullType(String)),
      if (direction != null)
        r'direction': encodeQueryParameter(
            _serializers, direction, const FullType(String)),
      if (sortDirection != null)
        r'sort_direction': encodeQueryParameter(
            _serializers, sortDirection, const FullType(String)),
      if (pageSize != null)
        r'page_size':
            encodeQueryParameter(_serializers, pageSize, const FullType(int)),
      if (fromColumnValue != null)
        r'from_column_value': encodeQueryParameter(
            _serializers, fromColumnValue, const FullType(String)),
      if (fromId != null)
        r'from_id':
            encodeQueryParameter(_serializers, fromId, const FullType(String)),
      if (dateRange != null)
        r'date_range': encodeQueryParameter(
            _serializers, dateRange, const FullType(String)),
      if (roleFilter != null)
        r'role_filter': encodeQueryParameter(
            _serializers, roleFilter, const FullType(String)),
      if (teamFilter != null)
    ...
    BuiltList<UserReport>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(UserReport)]),
            ) as BuiltList<UserReport>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<UserReport>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<User>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> getUsersWithInvalidEmails({
    int? page = 0,
    int? perPage = 60,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v4/users/invalid_emails';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [loginRequest] - User authentication object
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<User>> login({
    ...
    final _path = r'/api/v4/users/login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> logout({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/logout';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> permanentDeleteAllUsers({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> promoteGuestToUser({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/promote'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> revokeAllSessions({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/sessions/revoke/all'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> revokeSession({
    required String userId,
    required RevokeSessionRequest revokeSessionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/{user_id}/sessions/revoke'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(RevokeSessionRequest);
      _bodyData =
          _serializers.serialize(revokeSessionRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> revokeSessionsFromAllUsers({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/sessions/revoke/all';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> revokeUserAccessToken({
    required RevokeUserAccessTokenRequest revokeUserAccessTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/tokens/revoke';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RevokeUserAccessTokenRequest);
      _bodyData = _serializers.serialize(revokeUserAccessTokenRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  ///
  /// Parameters:
  /// * [searchUserAccessTokensRequest] - Search criteria
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserAccessTokenSanitized>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<UserAccessTokenSanitized>>> searchUserAccessTokens({
    required SearchUserAccessTokensRequest searchUserAccessTokensRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/tokens/search';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SearchUserAccessTokensRequest);
      _bodyData = _serializers.serialize(searchUserAccessTokensRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  ///
  /// Parameters:
  /// * [searchUsersRequest] - Search criteria
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<User>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> searchUsers({
    ...
    final _path = r'/api/v4/users/search';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> sendPasswordResetEmail({
    required SendPasswordResetEmailRequest sendPasswordResetEmailRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/password/reset/send';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SendPasswordResetEmailRequest);
      _bodyData = _serializers.serialize(sendPasswordResetEmailRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> sendVerificationEmail({
    required SendVerificationEmailRequest sendVerificationEmailRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v4/users/email/verify/send';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SendVerificationEmailRequest);
      _bodyData = _serializers.serialize(sendVerificationEmailRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> setDefaultProfileImage({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/image'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StatusOK>> setProfileImage({
    required String userId,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserAuthData] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserAuthData>> updateUserAuth({
    required String userId,
    ...
    final _path = r'/api/v4/users/{user_id}/auth'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(UserAuthData);
      _bodyData = _serializers.serialize(userAuthData, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserAuthData),
            ) as UserAuthData;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> verifyUserEmailWithoutToken({
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v4/users/{user_id}/email/verify/member'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
